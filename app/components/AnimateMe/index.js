  ...
  switch (type) {
   ...
   case 'fade-out':
    ...
    case 'directions-bus':
      return {
        transform: [
          { scale: animation.interpolate({ inputRange: [0, 0.5, 0.50001, 1], outputRange: [1, 1.1, 0.8, 1] }) },
          { translateY: animation.interpolate({ inputRange: [0, 0.5,0.50001, 1], outputRange: [0, 70, -70, 0] }) },
          { translateX: animation.interpolate({ inputRange: [0, 0.25, 0.5, 0.75, 1], outputRange: [0, 2, -2, 2, 0] }) },
        ],
      };
    ...
    case 'flight':
      return {
        transform: [
          { rotate: animation.interpolate({ inputRange: [0, 0.3, 0.9, 1], outputRange: ['0deg', '30deg', '30deg', '0deg'] }) },
          { translateY: animation.interpolate({ inputRange: [0, 0.2, 0.7,0.70001, 1], outputRange: [0, 0, -220, 220, 0] }) },
          { translateX: animation.interpolate({ inputRange: [0, 0.25, 0.7,0.70001, 1], outputRange: [0, 0, 5, 5, 0] }) },
        ],
      };
    ...
    case 'send':
      return {
        transform: [
          { rotate: animation.interpolate({ inputRange: [0, 0.2, 1], outputRange: ['0deg', '-45deg', '-45deg'] }) },
          { translateX: animation.interpolate({ inputRange: [0, 0.1, 1], outputRange: [0, 0, 300] }) },
        ],
      };
    ...
    case 'sunny':
      return {
        transform: [
          { translateY: animation.interpolate({ inputRange: [0, 0.4, 0.9, 1], outputRange: [100, 0, 0, -50] }) },
          { rotate: animation.interpolate({ inputRange: [0, 0.5, 1], outputRange: ['0deg', '0deg', '90deg'] }) },
        ],
      };
    ...
    case 'note':
      return {
        transform: [
          { translateY: animation.interpolate({ inputRange: [0, 0.4, 0.65, 0.8, 0.9, 1], outputRange: [100, -2, 0, -2, 0, -50] }) },
          { translateX: animation.interpolate({ inputRange: [0, 1], outputRange: [-50, -50] }) },
          { scale: animation.interpolate({ inputRange: [0, 0.5, 0.65, 0.8, 0.9, 1], outputRange: [0, 1, 0.9, 1, 0.9, 0] }) },
        ],
      };
    ...
    case 'moon':
      return {
        transform: [
          { translateY: animation.interpolate({ inputRange: [0, 0.4, 0.7, 0.8, 0.9, 1], outputRange: [100, -5, 0, -2, 0, -50] }) },
