...
class CommentsView extends Component {
  ...
  render() {
    ...
    return (
      <Modal onRequestClose={this.onClose} visible={isCommentsViewOpen} animationType={'slide'}>
        <View style={styles.container}>
          <Toolbar leftIcon={'arrow-back'} leftIconClick={this.onClose} title="Comments for Post" />
